...
public class ResearchRavagerCavalry extends ProductionItem {
    ...
    public Button getStartButton(ProductionPlacement prodBuilding, Keybinding hotkey) {
        return new Button(ResearchRavagerCavalry.itemName,
            ...
            () -> true,
            () -> BuildingServerboundPacket.startProduction(prodBuilding.originPos, ProductionItems.RESEARCH_RAVAGER_CAVALRY),
            null,
    ...
    public Button getCancelButton(ProductionPlacement prodBuilding, boolean first) {
        return new Button(ResearchRavagerCavalry.itemName,
            ...
            () -> false,
            () -> true,
            () -> BuildingServerboundPacket.cancelProduction(prodBuilding.minCorner, ProductionItems.RESEARCH_RAVAGER_CAVALRY, first),
            null,
            null
        );
    }
