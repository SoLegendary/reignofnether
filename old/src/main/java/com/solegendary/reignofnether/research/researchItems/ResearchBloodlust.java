...
public class ResearchBloodlust extends ProductionItem {
    ...
    public Button getStartButton(ProductionPlacement prodBuilding, Keybinding hotkey) {
        return new Button(ResearchBloodlust.itemName,
            ...
            () -> true,
            () -> BuildingServerboundPacket.startProduction(prodBuilding.originPos, ProductionItems.RESEARCH_BLOODLUST),
            null,
    ...
    public Button getCancelButton(ProductionPlacement prodBuilding, boolean first) {
        return new Button(ResearchBloodlust.itemName,
            ...
            () -> false,
            () -> true,
            () -> BuildingServerboundPacket.cancelProduction(prodBuilding.minCorner, ProductionItems.RESEARCH_BLOODLUST, first),
            null,
            null
        );
    }
