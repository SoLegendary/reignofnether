...
public class ProtectiveEnchantment extends AbstractEnchantment {
    ...
    public static final float MAX_ABSORB_HP_PER_FORTIFYING_LEVEL = 20;
    ...
    public List<FormattedCharSequence> getTooltipLines(HeroUnit hero) {
        return List.of(
                ...
                fcs(I18n.get("abilities.reignofnether.protective_enchantment.tooltip2", MAX_ABSORB_HP_PER_FORTIFYING_LEVEL)),
                fcs(""),
