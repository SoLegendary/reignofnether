...
public class ReignOfNetherCommonConfigs {
    ...
    static {
        ...
        ResearchCosts.RESEARCH_UPGRADE_MARKET.define(BUILDER);
    ...
    public static class BuildingCosts implements Costs {
        ...
        public static final ResourceCostConfigEntry PIGLIN_MARKET = ResourceCostConfigEntry.Building(0,75,75, 0, ResourceCosts.PIGLIN_MARKET, "Piglin Market Config");
    }
    public static class ResearchCosts implements Costs {
        ...
        public static final ResourceCostConfigEntry RESEARCH_UPGRADE_MARKET = ResourceCostConfigEntry.Research(0, 125, 125, 180, ResourceCosts.RESEARCH_UPGRADE_MARKET, "Market Upgrade Research Config");
