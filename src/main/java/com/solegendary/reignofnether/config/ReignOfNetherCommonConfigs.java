...
public class ReignOfNetherCommonConfigs {
    ...
    public static class UnitCosts implements Costs {
        ...
        public static final ResourceCostConfigEntry WARDEN = ResourceCostConfigEntry.Unit(300,0,150,50,6, ResourceCosts.WARDEN, "Warden Config");
        ...
        public static final ResourceCostConfigEntry IRON_GOLEM = ResourceCostConfigEntry.Unit(0,50,300,45,5, ResourceCosts.IRON_GOLEM, "Iron Golem Config");
