...
public class ReignOfNetherCommonConfigs {
    ...
    static {
        ...
        BuildingCosts.MARKET_MONSTERS.define(BUILDER);
        //Villagers
        BUILDER.comment("Villagers");
        ...
        BuildingCosts.MARKET_VILLAGERS.define(BUILDER);
        //Piglins
        BUILDER.comment("Piglins");
        ...
        BuildingCosts.MARKET_PIGLINS.define(BUILDER);
    ...
    public static class BuildingCosts implements Costs {
        ...
        public static final ResourceCostConfigEntry MARKET_MONSTERS = ResourceCostConfigEntry.Building(0,200,100, 0, ResourceCosts.MARKET_MONSTERS, "Monsters Market Config");
        ...
        public static final ResourceCostConfigEntry MARKET_VILLAGERS = ResourceCostConfigEntry.Building(0,200,100, 0, ResourceCosts.MARKET_VILLAGERS, "Villagers Market Config");
        ...
        public static final ResourceCostConfigEntry MARKET_PIGLINS = ResourceCostConfigEntry.Building(0,200,100, 0, ResourceCosts.MARKET_PIGLINS, "Piglins Market Config");
    }
