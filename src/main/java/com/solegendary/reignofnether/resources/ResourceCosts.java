...
public class ResourceCosts {
    ...
    public static final ResourceCost MARKET_MONSTERS = new ResourceCost(ID, "MARKET_MONSTERS");
    //Villagers
    ...
    public static final ResourceCost MARKET_VILLAGERS = new ResourceCost(ID, "MARKET_VILLAGERS");
    //Piglins
    ...
    public static final ResourceCost MARKET_PIGLINS = new ResourceCost(ID, "MARKET_PIGLINS");
    ...
    public static void deferredLoadResourceCosts() {
        ...
        MARKET_MONSTERS.bakeValues(ReignOfNetherCommonConfigs.BuildingCosts.MARKET_MONSTERS);
        // Villagers
        ...
        MARKET_VILLAGERS.bakeValues(ReignOfNetherCommonConfigs.BuildingCosts.MARKET_VILLAGERS);
        // Piglins
        ...
        MARKET_PIGLINS.bakeValues(ReignOfNetherCommonConfigs.BuildingCosts.MARKET_PIGLINS);
        // ******************* RESEARCH ******************* //
