...
public class ResourceBlocks {
    ...
    public static final List<Block> FOOD_BLOCKS = List.of(Blocks.FARMLAND, Blocks.WHEAT, Blocks.RED_MUSHROOM, Blocks.BROWN_MUSHROOM, Blocks.SWEET_BERRY_BUSH, Blocks.POTATOES, Blocks.CARROTS, Blocks.BEETROOTS, Blocks.SUGAR_CANE, Blocks.MELON, Blocks.PUMPKIN);
