package com.solegendary.reignofnether.building.research;
...
public class ResearchVindicatorAxes {
    ...
    public static Button getStartButton(ProductionBuilding prodBuilding, Keybinding hotkey) {
        return new Button(
                ...
                List.of(
                        ...
                        FormattedCharSequence.forward("\uE004 " + ResourceCosts.Creeper.TICKS/20 + "s", MyRenderer.iconStyle),
