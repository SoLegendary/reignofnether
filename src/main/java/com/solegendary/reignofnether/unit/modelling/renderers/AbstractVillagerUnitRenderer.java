...
public abstract class AbstractVillagerUnitRenderer<T extends AbstractIllager> extends MobRenderer<T, VillagerUnitModel<T>> {
    ...
    public static final ModelLayerLocation VILLAGER_ARMOR_OUTER_LAYER =
            new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(ReignOfNether.MOD_ID, "illager_outerarmor"), "main");
    public static final ModelLayerLocation VILLAGER_ARMOR_INNER_LAYER =
            new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(ReignOfNether.MOD_ID, "illager_innerarmor"), "main");
