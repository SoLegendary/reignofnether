    ...
    public UnitSpawnButton getPlaceButton() {
        return new UnitSpawnButton(
                ...
                List.of(
                        ...
                        Component.translatable("entity.reignofnether.spider_unit.tooltip1").getVisualOrderText(),
                        Component.translatable("entity.reignofnether.spider_unit.tooltip2").getVisualOrderText(),
                        FormattedCharSequence.EMPTY,
                        Component.translatable("entity.reignofnether.spider_unit.tooltip3").getVisualOrderText()
                )
        );
    }
