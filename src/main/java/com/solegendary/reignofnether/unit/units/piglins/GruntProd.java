...
public class GruntProd extends ProductionItem implements IUnitProductionItem {
    ...
    public UnitSpawnButton getPlaceButton() {
        return new UnitSpawnButton(
                ...
                List.of(
                        Component.translatable("entity.reignofnether.grunt_unit").withStyle(Style.EMPTY.withBold(true)).getVisualOrderText(),
                        FormattedCharSequence.EMPTY,
                        Component.translatable("entity.reignofnether.grunt_unit.tooltip1").getVisualOrderText(),
                        Component.translatable("entity.reignofnether.grunt_unit.tooltip2").getVisualOrderText()
                )
        );
    }
