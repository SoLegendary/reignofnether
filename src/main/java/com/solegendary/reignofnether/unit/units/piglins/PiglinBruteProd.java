...
public class PiglinBruteProd extends ProductionItem {

    public final static String itemName = "Piglin Brute";
    public final static ResourceCost cost = ResourceCosts.PIGLIN_BRUTE;

    public PiglinBruteProd(ProductionBuilding building) {
